...
// PgPool for PostgreSQL/PostGIS
lib.pgpool = new Pool({
  user: config.pgsqlDBUser,
  host: config.pgsqlDBHost,
  database: config.pgsqlDBName,
  password: config.pgsqlDBPass,
  port: config.pgsqlDBPort,
});

// PgClient for PostgreSQL/PostGIS
...
// MySQL Pool for MySQL connection
