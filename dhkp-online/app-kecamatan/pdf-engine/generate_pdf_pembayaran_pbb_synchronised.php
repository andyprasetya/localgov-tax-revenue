...
if (isset($_SESSION['kecamatanXweb'])) {
	...
	try {
		...
		if ($stmt_cnt->execute()) {
			...
			$stmt_sum_paid_sppt->bindValue(":kdprov", $_SESSION['kecamatanXweb']['KD_PROPINSI'], PDO::PARAM_STR);
			$stmt_sum_paid_sppt->bindValue(":kdkab", $_SESSION['kecamatanXweb']['KD_DATI2'], PDO::PARAM_STR);
			$stmt_sum_paid_sppt->bindValue(":kdkec", $_SESSION['kecamatanXweb']['KD_KECAMATAN'], PDO::PARAM_STR);
			$stmt_sum_paid_sppt->bindValue(":kddesa", $kode_kelurahan, PDO::PARAM_STR);
			$stmt_sum_paid_sppt->bindValue(":thnpajak", $_SESSION['tahunPAJAK'], PDO::PARAM_STR);
			if ($stmt_sum_paid_sppt->execute()) {
				...
				$stmt_select_data->bindValue(":kdprov", $_SESSION['kecamatanXweb']['KD_PROPINSI'], PDO::PARAM_STR);
				$stmt_select_data->bindValue(":kdkab", $_SESSION['kecamatanXweb']['KD_DATI2'], PDO::PARAM_STR);
				$stmt_select_data->bindValue(":kdkec", $_SESSION['kecamatanXweb']['KD_KECAMATAN'], PDO::PARAM_STR);
