...
<html lang="en">
  <head>
    ...
    <link href="../trulogix-cdn/leaflet-0.7.7/leaflet.css" rel="stylesheet"/>
    <link href="../trulogix-cdn/datatables/minimalist-alt/datatables.min.css" rel="stylesheet"/>
    <link href="../trulogix-cdn/leaflet-plugins/leaflet-markercluster/MarkerCluster.css" rel="stylesheet"/>
    <link href="../trulogix-cdn/leaflet-plugins/leaflet-markercluster/MarkerCluster.Default.css" rel="stylesheet"/>
    <link href="../trulogix-cdn/leaflet-plugins/leaflet-locatecontrol/L.Control.Locate.css" rel="stylesheet"/>
    <link href="../trulogix-cdn/leaflet-plugins/leaflet-groupedlayercontrol/leaflet.groupedlayercontrol.css" rel="stylesheet"/>
  ...
  <body class='body-for-application'>
  		...
  		<div class='container-fluid'>
  			...
  			<div id='navbar' class='navbar-collapse collapse'>
  				<ul class='nav navbar-nav navbar-left'>
  					...
  					<li class='top-menu'><a id='left-sidebar-app|mapatda_desa_data' href='#' class='ajax-menu'><i class='fa fa-file'></i> Data</a></li>
  				</ul>
  				<ul class='nav navbar-nav navbar-right'>
  					<li class='top-menu'><a id='left-sidebar-app|mapatda_desa_syncdata' href='#' class='ajax-menu'><i class='fa fa-database'></i> Sinkronisasi Data</a></li>
  					<li class='top-menu'><a id='left-sidebar-app|mapatda_desa_setting' href='#' class='ajax-menu'><i class='fa fa-cog'></i> Pengaturan</a></li>
    ...
    <script src="../trulogix-cdn/leaflet-0.7.7/leaflet.js"></script>
    <script src="../trulogix-cdn/leaflet-plugins/leaflet-markercluster/leaflet.markercluster.js"></script>
    <script src="../trulogix-cdn/leaflet-plugins/leaflet-locatecontrol/L.Control.Locate.min.js"></script>
    <script src="../trulogix-cdn/leaflet-plugins/leaflet-groupedlayercontrol/leaflet.groupedlayercontrol.js"></script>
    ...
    <script src="../trulogix-cdn/moment/moment.min.js"></script>
    ...
    <script src="./local-assets/datatables/minimalist-alt/datatables.min.js"></script>
    <!-- <script src="./local-assets/dom-engine/html5engine.min.js"></script> -->
    <script src="./dev-js/app_timeout.js"></script>
    <script src="./dev-js/html5_engine.js"></script>
    <script src="./dev-js/app_engine.js"></script>
    <script src="./dev-js/menu_engine.js"></script>
    <script src="./dev-js/form_engine.js"></script>
    <script src="./dev-js/form_action_engine.js"></script>
    <script src="./dev-js/data_engine.js"></script>
    <script src="./dev-js/datatables_engine.js"></script>
    <script src="./dev-js/component_engine.js"></script>
    <script src="./dev-js/map_engine.js"></script>
    <script src="./dev-js/pdf_engine.js"></script>
    <script src="./dev-js/chart_engine.js"></script>
    <script>
    	$(document).ready(function(){
    		app_engine.generateStartupPage();
    		app_engine.enableTopMenu();
    	});
    </script>
  </body>
</html>
