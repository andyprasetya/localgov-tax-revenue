			...
			if (intval($rowsfound)>0) {
				...
				if ($stmt->execute()) {
					...
					$objPHPExcel->setActiveSheetIndex(0)
						...
						->setCellValue('B2', 'STATUS: BELUM BAYAR')
...
header('Content-Disposition: attachment;filename="REKAPITULASI_PER_PETUGAS_'.trim($namaPetugas).'_BELUM_BAYAR_'.Date('dmY_His').'.xlsx"');
