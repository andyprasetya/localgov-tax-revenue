...
header('Content-Disposition: attachment;filename="DHKP_'.$kode_propinsi.''.$kode_dati2.''.$kode_kecamatan.''.$kode_kelurahan.'_'.$namaKelurahan.'_0201'.Date('Y').'_'.Date('dmY_His').'.xlsx"');
